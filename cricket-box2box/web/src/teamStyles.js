...
export const FRANCHISE_STYLE = {
  ...
  "Kolkata Knight Riders": { logo: `${LOGOS_BASE}/kolkata-knight-riders.svg`, bg: "#141010", fg: "#F2C028" },
  ...
  "Rajasthan Royals": { logo: `${LOGOS_BASE}/rajasthan-royals.svg`, bg: "#1B1F4B", fg: "#f3ecd8" },
  "Sunrisers Hyderabad": { logo: `${LOGOS_BASE}/sunrisers-hyderabad.svg`, bg: "#FF822A", fg: "#0b2818" },
  "Gujarat Titans": { logo: `${LOGOS_BASE}/gujarat-titans.svg`, bg: "#D4AF37", fg: "#1B2133" },
